...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Find the first valid ID with optimized HTTP requests and save it to a file.")
    parser.add_argument("--bearer_token", required=True, help="Bearer token for API authentication.")
    parser.add_argument("--output_file", default=OUTPUT_FILE, help="File path for saving the first valid ID.")
